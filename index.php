...
<body>
    ...
    <button type="submit" name="submit" id="add-btn-desc">Add description</button>
    
    <button type="submit" name="submit" id="add-btn-task">Add Task</button>
    </form>
    </section>
